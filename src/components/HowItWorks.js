      ...
      <div className="container mx-auto px-6 md:max-w-4xl relative">
          ...
          <div className="max-w-md text-left"> {/* Begrenzung der Textbreite und linksbündig */}
            ...
            <div className="space-y-6">
              <div className="flex items-start space-x-4">
                <div className="w-6 h-6 flex-shrink-0"> {/* Fester Wrapper für das Icon */}
                  <FaCheckCircle className="text-orange-400 w-full h-full" />
                </div>
                <div>
        ...
        <div className="mt-10 md:mt-0 md:absolute md:top-[30%] md:right-[5%] p-8 bg-white rounded-xl shadow-lg text-center w-full md:w-80 z-20">
          ...
          <p className="text-gray-600 italic">
            “Alles war hervorragend organisiert, die Durchführung ein voller Erfolg! Der Kurs hat echten Mehrwert gebracht und wirkt nachhaltig – absolut empfehlenswert!”
          </p>
        </div>
      </div>
    </section>
